    ...
    public static final Command scoreFirst = new LambdaCommand()
            .setStart(() -> {
                ...
                follower.followPath(
                        follower.pathBuilder()
                                .addPath(
                                        new BezierLine(new Pose(11.000, 8.000),
                                                new Pose(59.000, 22.000))
                                )
                                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                                .build()
    ...
    public static final Command grabthird = new LambdaCommand()
            .setStart(() -> {
                ...
                follower.followPath(
                        follower.pathBuilder()
                                .addPath(
                                        new BezierLine(new Pose(59.000, 22.000), new Pose(11.000, 15.000))
                                )
                                .build()
                );
