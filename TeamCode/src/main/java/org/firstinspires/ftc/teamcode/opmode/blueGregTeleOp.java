...
public class blueGregTeleOp extends NextFTCOpMode {
    ...
    public blueGregTeleOp() {
        ...
        VisionDistanceHelper.GOAL_TARGET_X_FAR =  144 - 136;
        VisionDistanceHelper.GOAL_TARGET_Y_FAR = 144;

        VisionDistanceHelper.GOAL_TARGET_X =  144 - 132;
    ...
    public void onStartButtonPressed() {
        ...
        Gamepads.gamepad1().leftStickButton()
                .whenBecomesTrue(new LambdaCommand().setStart(() ->
                        follower().setPose(new Pose(11.37, 8.5f, Math.toRadians(180)))
                        ));
    ...
    public void onUpdate () {
        ...
        telemetry.addData("Heading", pedroPose.getHeading());
