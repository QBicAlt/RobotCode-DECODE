...
public class redGregTeleOp extends NextFTCOpMode {
    ...
    public redGregTeleOp() {
        ...
        VisionDistanceHelper.GOAL_TARGET_X_FAR = 144;
    ...
    public void onStartButtonPressed() {
        ...
        driveCmd = new PedroDriverControlled(
                ...
                () -> -gamepad1.right_stick_x * TURN_SENSITIVITY
        );
    ...
    public void onUpdate() {
        ...
        if (isSafetyPressed && Math.abs(manualPower) > 0.05 && !Turret.INSTANCE.resetLockout) {
            if (Turret.INSTANCE.isLimitPressed()) {
                ...
                Turret.INSTANCE.setRawPower(manualPower * 0.1);
            }
        } else {
        ...
        telemetry.addData("Y far", VisionDistanceHelper.GOAL_TARGET_Y_FAR);
        telemetry.addData("x far", VisionDistanceHelper.GOAL_TARGET_X_FAR);
