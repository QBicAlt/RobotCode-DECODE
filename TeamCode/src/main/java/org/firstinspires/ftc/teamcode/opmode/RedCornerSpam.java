    ...
    public static final Command scoreFirst = new LambdaCommand()
            .setStart(() -> {
                ...
                follower.followPath(
                        follower.pathBuilder()
                                .addPath(
                                        new BezierLine(new Pose(9.000, 10.000).mirror(),
    ...
    public static final Command grabsecond = new LambdaCommand()
            .setStart(() -> {
                ...
                follower.followPath(
                        follower.pathBuilder()
                                .addPath(
                                        new BezierLine(new Pose(59.000, 22.000).mirror(),
    ...
    public static final Command scorethird = new LambdaCommand()
            .setStart(() -> {
                ...
                follower.followPath(
                        follower.pathBuilder()
                                .addPath(
                                        new BezierLine(new Pose(9.822, 15.803).mirror(),
                                                new Pose(59.000, 22.000).mirror())
                                )
                                .setConstantHeadingInterpolation(Math.toRadians(0))
                                .build()
